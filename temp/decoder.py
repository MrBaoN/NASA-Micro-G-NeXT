...
class decoder(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        ...
        self.settings = Qt.QSettings("GNU Radio", "decoder")
        ...
        self.iio_pluto_source_0.set_samplerate(680000)
        ...
        self.connect((self.digital_binary_slicer_fb_0, 0), (self.network_tcp_sink_0, 0))
