...
class plutoTest(gr.top_block, Qt.QWidget):
    ...
    def __init__(self):
        gr.top_block.__init__(self, "plutoTest", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("plutoTest")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "plutoTest")
        ...
        self._rx_gain_range = qtgui.Range(0, 70, 1, 45, 200)
        ...
        self.iio_pluto_sink_0 = iio.fmcomms2_sink_fc32('ip:192.168.2.1' if 'ip:192.168.2.1' else iio.get_pluto_uri(), [True, True], 32768, True)
        self.iio_pluto_sink_0.set_len_tag_key('')
        self.iio_pluto_sink_0.set_bandwidth(20000000)
        self.iio_pluto_sink_0.set_frequency(406025000)
        ...
        self.blocks_vector_source_x_0 = blocks.vector_source_c((1, -1, -1, 1, -1, 1,), True, 1, [])
        self.blocks_throttle2_0 = blocks.throttle( gr.sizeof_gr_complex*1, samp_rate, True, 0 if "auto" == "auto" else max( int(float(0.1) * samp_rate) if "auto" == "time" else int(0.1), 1) )
        self.blocks_repeat_0 = blocks.repeat(gr.sizeof_gr_complex*1, 850)
        ...
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_const_sink_x_2_0, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.qtgui_time_sink_x_0_0_0, 0))
        self.connect((self.iio_pluto_source_0, 0), (self.root_raised_cosine_filter_0_0, 0))
        ...
        self.connect((self.root_raised_cosine_filter_1, 0), (self.iio_pluto_sink_0, 0))
    ...
    def set_samp_rate(self, samp_rate):
        ...
        self.root_raised_cosine_filter_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 400, 0.8, 132))
        self.root_raised_cosine_filter_0_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 400, 0.8, 132))
        self.root_raised_cosine_filter_1.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 400, 0.8, 132))
        self.root_raised_cosine_filter_1_0.set_taps(firdes.root_raised_cosine(1, self.samp_rate, 400, 0.8, 132))
