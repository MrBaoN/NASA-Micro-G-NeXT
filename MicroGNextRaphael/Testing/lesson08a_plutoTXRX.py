...
class lesson08a_plutoTXRX(gr.top_block, Qt.QWidget):

    def __init__(self):
        gr.top_block.__init__(self, "lesson08a_plutoTXRX", catch_exceptions=True)
        Qt.QWidget.__init__(self)
        self.setWindowTitle("lesson08a_plutoTXRX")
        ...
        self.settings = Qt.QSettings("gnuradio/flowgraphs", "lesson08a_plutoTXRX")
        ...
        self._tx_attenuation_range = qtgui.Range(0, 80, 1, 0, 200)
        ...
        self._freq_range = qtgui.Range(-100e3, 100e3, 1, 50e3, 200)
        ...
        self.iio_pluto_source_0.set_samplerate(2084000)
        ...
        self.iio_pluto_sink_0.set_samplerate(2084000)
...
def main(top_block_cls=lesson08a_plutoTXRX, options=None):
